...
//Full Log Block	
	...
	recipes.addShaped(<customitems:full_oak_log> * 4, [[<terrafirmacraft:item.Log:0>, <terrafirmacraft:item.Log:0>], [<terrafirmacraft:item.Log:0>, <terrafirmacraft:item.Log:0>]]);
	recipes.addShaped(<customitems:full_aspen_log> * 4, [[<terrafirmacraft:item.Log:1>, <terrafirmacraft:item.Log:1>], [<terrafirmacraft:item.Log:1>, <terrafirmacraft:item.Log:1>]]);
	recipes.addShaped(<customitems:full_birch_log> * 4, [[<terrafirmacraft:item.Log:2>, <terrafirmacraft:item.Log:2>], [<terrafirmacraft:item.Log:2>, <terrafirmacraft:item.Log:2>]]);
	recipes.addShaped(<customitems:full_chestnut_log> * 4, [[<terrafirmacraft:item.Log:3>, <terrafirmacraft:item.Log:3>], [<terrafirmacraft:item.Log:3>, <terrafirmacraft:item.Log:3>]]);
	recipes.addShaped(<customitems:full_douglas_fir_log> * 4, [[<terrafirmacraft:item.Log:4>, <terrafirmacraft:item.Log:4>], [<terrafirmacraft:item.Log:4>, <terrafirmacraft:item.Log:4>]]);
	recipes.addShaped(<customitems:full_hickory_log> * 4, [[<terrafirmacraft:item.Log:5>, <terrafirmacraft:item.Log:5>], [<terrafirmacraft:item.Log:5>, <terrafirmacraft:item.Log:5>]]);
	recipes.addShaped(<customitems:full_maple_log> * 4, [[<terrafirmacraft:item.Log:6>, <terrafirmacraft:item.Log:6>], [<terrafirmacraft:item.Log:6>, <terrafirmacraft:item.Log:6>]]);
	recipes.addShaped(<customitems:full_ash_log> * 4, [[<terrafirmacraft:item.Log:7>, <terrafirmacraft:item.Log:7>], [<terrafirmacraft:item.Log:7>, <terrafirmacraft:item.Log:7>]]);
	recipes.addShaped(<customitems:full_pine_log> * 4, [[<terrafirmacraft:item.Log:8>, <terrafirmacraft:item.Log:8>], [<terrafirmacraft:item.Log:8>, <terrafirmacraft:item.Log:8>]]);
	recipes.addShaped(<customitems:full_sequoia_log> * 4, [[<terrafirmacraft:item.Log:9>, <terrafirmacraft:item.Log:9>], [<terrafirmacraft:item.Log:9>, <terrafirmacraft:item.Log:9>]]);
	recipes.addShaped(<customitems:full_spruce_log> * 4, [[<terrafirmacraft:item.Log:10>, <terrafirmacraft:item.Log:10>], [<terrafirmacraft:item.Log:10>, <terrafirmacraft:item.Log:10>]]);
	recipes.addShaped(<customitems:full_sycamore_log> * 4, [[<terrafirmacraft:item.Log:11>, <terrafirmacraft:item.Log:11>], [<terrafirmacraft:item.Log:11>, <terrafirmacraft:item.Log:11>]]);
	recipes.addShaped(<customitems:full_white_cedar_log> * 4, [[<terrafirmacraft:item.Log:12>, <terrafirmacraft:item.Log:12>], [<terrafirmacraft:item.Log:12>, <terrafirmacraft:item.Log:12>]]);
	recipes.addShaped(<customitems:full_white_elm_log> * 4, [[<terrafirmacraft:item.Log:13>, <terrafirmacraft:item.Log:13>], [<terrafirmacraft:item.Log:13>, <terrafirmacraft:item.Log:13>]]);
	recipes.addShaped(<customitems:full_willow_log> * 4, [[<terrafirmacraft:item.Log:14>, <terrafirmacraft:item.Log:14>], [<terrafirmacraft:item.Log:14>, <terrafirmacraft:item.Log:14>]]);
	recipes.addShaped(<customitems:full_kapok_log> * 4, [[<terrafirmacraft:item.Log:15>, <terrafirmacraft:item.Log:15>], [<terrafirmacraft:item.Log:15>, <terrafirmacraft:item.Log:15>]]);
	recipes.addShaped(<customitems:full_acacia_log> * 4, [[<terrafirmacraft:item.Log:16>, <terrafirmacraft:item.Log:16>], [<terrafirmacraft:item.Log:16>, <terrafirmacraft:item.Log:16>]]);

	recipes.addShaped(<customitems:full_juniper_log> * 4, [[<psychedelicraft:psycheLog>, <psychedelicraft:psycheLog>], [<psychedelicraft:psycheLog>, <psychedelicraft:psycheLog>]]);
	recipes.addShaped(<customitems:full_ebony_log> * 4, [[<customitems:ebony_log>, <customitems:ebony_log>], [<customitems:ebony_log>, <customitems:ebony_log>]]);
	recipes.addShaped(<customitems:full_mahogany_log> * 4, [[<customitems:mahogany_log>, <customitems:mahogany_log>], [<customitems:mahogany_log>, <customitems:mahogany_log>]]);
	recipes.addShaped(<customitems:full_redwood_log> * 4, [[<customitems:redwood_log>, <customitems:redwood_log>], [<customitems:redwood_log>, <customitems:redwood_log>]]);
	recipes.addShaped(<customitems:full_eucalyptus_log> * 4, [[<customitems:eucalyptus_log>, <customitems:eucalyptus_log>], [<customitems:eucalyptus_log>, <customitems:eucalyptus_log>]]);
	recipes.addShaped(<customitems:full_cherry_log> * 4, [[<customitems:cherry_log>, <customitems:cherry_log>], [<customitems:cherry_log>, <customitems:cherry_log>]]);
	recipes.addShaped(<customitems:full_jacaranda_log> * 4, [[<customitems:jacaranda_log>, <customitems:jacaranda_log>], [<customitems:jacaranda_log>, <customitems:jacaranda_log>]]);
	//recipes.addShaped(<customitems:full_rowan_log> * 4, [[<dendrology:logs0:2>, <dendrology:logs0:2>], [<dendrology:logs0:2>, <dendrology:logs0:2>]]);
	//recipes.addShaped(<customitems:full_hagberry_log> * 4, [[<dendrology:logs1:3>, <dendrology:logs1:3>], [<dendrology:logs1:3>, <dendrology:logs1:3>]]);
...
var logWood = <ore:logWood>;
	logWood.add(<customitems:stripped_oak_log>);
	logWood.add(<customitems:stripped_aspen_log>);
	logWood.add(<customitems:stripped_birch_log>);
	logWood.add(<customitems:stripped_chestnut_log>);
	logWood.add(<customitems:stripped_douglas_fir_log>);
	logWood.add(<customitems:stripped_hickory_log>);
	logWood.add(<customitems:stripped_maple_log>);
	logWood.add(<customitems:stripped_ash_log>);
	logWood.add(<customitems:stripped_pine_log>);
	logWood.add(<customitems:stripped_sequoia_log>);
	logWood.add(<customitems:stripped_spruce_log>);
	logWood.add(<customitems:stripped_sycamore_log>);
	logWood.add(<customitems:stripped_white_cedar_log>);
	logWood.add(<customitems:stripped_white_elm_log>);
	logWood.add(<customitems:stripped_willow_log>);
	logWood.add(<customitems:stripped_kapok_log>);
	logWood.add(<customitems:stripped_acacia_log>);
	...
	logWood.add(<customitems:full_oak_log>);
	logWood.add(<customitems:full_aspen_log>);
	logWood.add(<customitems:full_birch_log>);
	logWood.add(<customitems:full_chestnut_log>);
	logWood.add(<customitems:full_douglas_fir_log>);
	logWood.add(<customitems:full_hickory_log>);
	logWood.add(<customitems:full_maple_log>);
	logWood.add(<customitems:full_ash_log>);
	logWood.add(<customitems:full_pine_log>);
	logWood.add(<customitems:full_sequoia_log>);
	logWood.add(<customitems:full_spruce_log>);
	logWood.add(<customitems:full_sycamore_log>);
	logWood.add(<customitems:full_white_cedar_log>);
	logWood.add(<customitems:full_white_elm_log>);
	logWood.add(<customitems:full_willow_log>);
	logWood.add(<customitems:full_kapok_log>);
	logWood.add(<customitems:full_acacia_log>);

	logWood.add(<customitems:full_juniper_log>);
	logWood.add(<customitems:full_ebony_log>);
	logWood.add(<customitems:full_mahogany_log>);
	logWood.add(<customitems:full_redwood_log>);
	logWood.add(<customitems:full_eucalyptus_log>);
	logWood.add(<customitems:full_cherry_log>);
	logWood.add(<customitems:full_jacaranda_log>);
	logWood.add(<customitems:full_rowan_log>);
	logWood.add(<customitems:full_hagberry_log>);
